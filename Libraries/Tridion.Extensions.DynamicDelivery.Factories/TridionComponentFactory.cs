...
namespace Tridion.Extensions.DynamicDelivery.Factories
{
    ...
    public class TridionComponentFactory : TridionFactoryBase, IComponentFactory
    {
        ...
        public List<string> GetComponents(string[] componentUris)
        {
            ...
            var components =
                componentUris
                .Select(componentUri => (ComponentPresentation)cpFactory.FindAllComponentPresentations(componentUri)[0])
                .Where(cp => cp != null)
        ...
        private IComponentMeta CreateComponentMeta(ContentDelivery.Meta.IComponentMeta v)
        {
